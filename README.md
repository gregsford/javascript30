...
Day 21: GEOLOCATION (completed: 9/25/2022)
...
Day 29: COUNTDOWN TIMER (completed: 9/22/2022)

This weekend I am going to work on this project more. At the time of this review I am working 2 jobs 6 days a week trying to fit in time for coding and working on both of my YouTube channels: (<a href="https://www.youtube.com/channel/UC7i4bH0u8xv4b47SN3_bHwQ">Drummond Reacts</a> and <a href="https://www.youtube.com/channel/UC7A9BktiAOLx4sfosj8zJfQ">My other Youtube Channel for Coding</a> - feel free to check those out if you want to). So trying to prioritize my time between practing Javascript, The Odin Project, freeCodeCamp, YouTube coding videos, my own projects, and working on the other videos for my channels is hard to do. If I can set up a countdown timer and keep it going while I work on other things will definitely help me keep tasks in check.

Sorry about that mess. The lesson was very informative. I definitely understood the concepts in this one a lot more than the previous videos I watched. It was cool seeing how the different times and dates are all set up automatically in JS, especially the time from January 1, 1970 until now. And now. And now. And now. And now...
Overall this is definitely something I can use personally in my current situation as well as future situations. When I eventually get a remote coding job, I can have a timer set up for when I need a break for lunch or if I need some time to clear my head with a difficult problem that I'm having trouble resolving and don't spend too much time away if it's not an option. This is definitely very practical to every day use.
