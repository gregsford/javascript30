...
This weekend I am going to work on this project more. At the time of this review I am working 2 jobs 6 days a week trying to fit in time for coding and working on both of my YouTube channels(<a href="https://www.youtube.com/channel/UC7i4bH0u8xv4b47SN3_bHwQ">Drummond Reacts</a> for music reactions and <a href="https://www.youtube.com/channel/UC7A9BktiAOLx4sfosj8zJfQ">My other Youtube Channel for Coding</a> - Feel free to check those out if you want to). So trying to prioritize my time between practing Javascript, The Odin Project, freeCodeCamp, YouTube coding videos, my own projects, and working on the other videos for my channels is hard to do. If I can set up a countdown timer and keep it going while I work on other things will definitely help me keep tasks in check.
